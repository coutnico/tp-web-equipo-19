...
<div style="margin-top: 1%"  > 
    ...
    <div  style="display: flex; margin-top: 1%;"> 
     <p class="fs-5" > INGRESE EL ID DE LA CATEGORIA: </p>
     <asp:TextBox ID="txtIDCatBuscado" runat="server" type="numeric" OnTextChanged="txtIDCatBuscado_TextChanged" AutoPostBack="true" >  </asp:TextBox> <%--Habilito el autopostback, para que no me obligue a poner un boton de confirmacion para text changed--%>
